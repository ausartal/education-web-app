  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <p className="mt-1 text-sm text-[#5B6475]">
        Sertifikat diterbitkan untuk ujian dengan predikat Unggul ke atas.
      </p>
      ...
      {certificates.length === 0 ? (
        <div className="mt-8 rounded-lg bg-white py-12 text-center ring-1 ring-[#DCE5F2]">
          ...
          <p className="mt-1 text-xs text-[#9CA3AF]">
            Selesaikan ujian dengan predikat Unggul atau lebih tinggi untuk mendapatkan sertifikat.
          </p>
          <Link href="/exam"
